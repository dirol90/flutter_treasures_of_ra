...
class _MainScreenState extends State<MainScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            CupertinoButton(
                child: Text("Convert"),
                onPressed: () async {
                  if (myController.text.isNotEmpty) bfUrl = "";
  ...
  _launchURLWithPolicy(BuildContext context) async {
    const url =
        'https://sites.google.com/view/treasures-of-ra-privacy-policy/privacy-policy';
  ...
  _launchURLWithTerms(BuildContext context) async {
    const url =
        'https://sites.google.com/view/treasures-of-ra-terms-conditio/treasures-of-ra-tc';
    if (await canLaunch(url)) {
      launch(url);
    } else {
      throw 'Could not launch $url';
